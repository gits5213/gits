            ...
            <div className='page-tab-body' style={{ 
                ...
                <Grid className='page-tab-grid'>
                    <Cell className='page-tab-first-col' col={12}>
                        <div className='contact-'>                            <div className='contact-section-1'>
                                ...
                                {/* Contact Form */}
                                <div style={{ maxWidth: '700px', margin: '0 auto 80px', padding: '30px', backgroundColor: '#fff', borderRadius: '8px', boxShadow: '0 2px 8px rgba(0,0,0,0.1)' }}>
