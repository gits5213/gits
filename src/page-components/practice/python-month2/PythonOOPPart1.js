...
export default function PythonOOPPart1() {
  return (
    <PythonTopicLayout title="Object-Oriented Programming Part 1" week={7} month={2}>
      <p style={{ marginBottom: '16px' }}>Create classes and objects. Use attributes, methods, and the <code>__init__</code> constructor.</p>
      ...
      <pre style={{ background: '#1e293b', color: '#e2e8f0', padding: '16px', borderRadius: '8px', overflowX: 'auto', fontSize: '14px' }}>{`class Student:
