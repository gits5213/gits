...
class Exam extends Component {
    constructor(props) {
        ...
        const studentInfo = typeof window !== 'undefined' ? JSON.parse(localStorage.getItem(`studentInfo_${this.examId}`) || 'null') : null;
    ...
    componentDidMount() {
        ...
        if (this.state.examTaken && typeof window !== 'undefined' && window.localStorage) {
