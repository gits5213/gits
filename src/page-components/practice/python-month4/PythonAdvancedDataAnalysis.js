...
export default function PythonAdvancedDataAnalysis() {
  return (
    <PythonTopicLayout title="Advanced Data Analysis" week={15} month={4}>
      <p style={{ marginBottom: '16px' }}>Aggregation, correlation basics, data slicing, and trend analysis.</p>
      <h3 style={{ color: '#00416A', fontSize: '18px', marginTop: '24px', marginBottom: '12px' }}>What you'll practice</h3>
      <ul style={{ paddingLeft: '20px', marginBottom: '16px' }}>
        <li>Aggregation and correlation basics</li>
        <li>Data slicing and trend analysis</li>
      </ul>
      <h3 style={{ color: '#00416A', fontSize: '18px', marginTop: '24px', marginBottom: '12px' }}>Try it</h3>
      <pre style={{ background: '#1e293b', color: '#e2e8f0', padding: '16px', borderRadius: '8px', overflowX: 'auto', fontSize: '14px' }}>{`df.corr()
df.agg(["mean", "sum"])`}</pre>
