...
export default function PythonAutomation() {
  return (
    <PythonTopicLayout title="Python Automation" week={11} month={3}>
      <p style={{ marginBottom: '16px' }}>Automate repetitive tasks with the <code>os</code> and <code>shutil</code> modules. File and folder automation.</p>
      <h3 style={{ color: '#00416A', fontSize: '18px', marginTop: '24px', marginBottom: '12px' }}>What you'll practice</h3>
      <ul style={{ paddingLeft: '20px', marginBottom: '16px' }}>
        <li>Automating repetitive tasks</li>
        <li>OS and shutil basics</li>
