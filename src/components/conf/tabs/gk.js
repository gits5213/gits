...
const gk = () => {
    return(
        <div className='page-tab-body'>
            ...
            <div>
                <h5>
                    After Giving 1,000 Interviews, I've Found List of Questions That Matter | Hiring for culture fit can seem like a mystery, but this list of interview questions will help you get it right every time.
                </h5>
            </div>
            <div>
                <h5>
