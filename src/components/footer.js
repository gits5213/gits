        ...
        <Footer size="mega">
            <FooterSection type="middle" className='tc'>
                <FooterDropDownSection title="Features">
                    <FooterLinkList>
                        <a className='f6 grow no-underline br-pill ba bw1 ph3 pv2 mb2 dib dark-green' href={link.ITNYCUSA} target="_blank" rel="noopener noreferrer">WordPress Website</a>
                ...
                <FooterDropDownSection title="Details">
                    <FooterLinkList>
                        <a className='f6 grow no-underline br-pill ba bw1 ph3 pv2 mb2 dib dark-green' href={link.ITTCIWEBSITE} target="_blank" rel="noopener noreferrer">UI Automation</a>
                        <a className='f6 grow no-underline br-pill ba bw1 ph3 pv2 mb2 dib dark-green' href={link.ITTCIWEBSITE} target="_blank" rel="noopener noreferrer">API Automation</a>
                        <a className='f6 grow no-underline br-pill ba bw1 ph3 pv2 mb2 dib dark-green' href={link.ITTCIWEBSITE} target="_blank" rel="noopener noreferrer">UI Manual</a>
                        <a className='f6 grow no-underline br-pill ba bw1 ph3 pv2 mb2 dib dark-green' href={link.ITTCIWEBSITE} target="_blank" rel="noopener noreferrer">API Manual</a>
                        
                    </FooterLinkList>
                </FooterDropDownSection>
                <FooterDropDownSection title="Technology">
                    <FooterLinkList>
                        <a className='f6 grow no-underline br-pill ba bw1 ph3 pv2 mb2 dib dark-green' href={link.HOW_IT_WORKS} target="_blank" rel="noopener noreferrer">How it works</a>
                ...
                <SocialIcon />
                    <p className='all-right f7 white-70 mt4 tc copyIcon'>
                        ...
                        <a href={link.ITNYCUSA} target="_blank" rel="noopener noreferrer"> IT Training {'&'} Consultant Inc., </a> 
                        All Rights Reserved
                    </p>
                </div>
        </Footer>
