    ...
    return(
        <div className='page-tab-body'>
            ...
            <div className='tc pt4'>
                <a class='f6 grow no-underline br-pill ph3 pv2 mb2 dib white bg-red' href={link.READYAPI_DOCS} target="_blank" rel="noopener noreferrer">
                    <img className='pr2' src={link.READYAPI_DOCS} alt='github log' /> 
                    ReadyAPI Docs                
                </a>
                <a class='f6 grow no-underline br-pill ph3 pv2 mb2 dib white bg-green' href={link.READYAPI} target="_blank" rel="noopener noreferrer">
